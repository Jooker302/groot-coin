          ...
          <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none">
            ...
            <div className="flex flex-col h-full p-6 bg-gray-200" data-aos="fade-up">
              ...
              <div className="text-gray-700 font-medium flex justify-center mt-6 pt-5 border-t border-gray-700">
                ...
                <a className="text-[#d8aa6f] text-center hover:text-gray-200 transition duration-150 ease-in-out" href="https://dx.app">DxSale</a>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-200" data-aos="fade-up" data-aos-delay="200">
              ...
              <div className="text-gray-700 font-medium flex justify-center mt-6 pt-5 border-t border-gray-700">
                {/* <cite className="text-gray-200 not-italic"></cite>  */}
                <a className="text-[#d8aa6f] text-center hover:text-gray-200 transition duration-150 ease-in-out" href="#team">ARB</a>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-200" data-aos="fade-up" data-aos-delay="400">
              ...
              <div className="text-gray-700 font-medium flex justify-center mt-6 pt-5 border-t border-gray-700">
                {/* <cite className="text-gray-200 not-italic"></cite>  */}
                <a className="text-[#d8aa6f] text-center hover:text-gray-200 transition duration-150 ease-in-out" href="#team">Coinbase</a>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-200" data-aos="fade-up" data-aos-delay="600">
              <div>
                {/* <div className="relative inline-flex flex-col mb-4">
                  <Image className="rounded-full" src={TestimonialImage01} width={48} height={48} alt="Testimonial 01" />
                  <svg className="absolute top-0 right-0 -mr-3 w-6 h-5 fill-current text-purple-600" viewBox="0 0 24 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="text-gray-700 font-medium flex justify-center mt-6 pt-5 border-t border-gray-700">
                {/* <cite className="text-gray-200 not-italic"></cite>  */}
                <a className="text-[#d8aa6f] text-center hover:text-gray-200 transition duration-150 ease-in-out" href="#team">1inch</a>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-200" data-aos="fade-up" data-aos-delay="800">
              <div>
                {/* <div className="relative inline-flex flex-col mb-4">
                  <Image className="rounded-full" src={TestimonialImage01} width={48} height={48} alt="Testimonial 01" />
                  <svg className="absolute top-0 right-0 -mr-3 w-6 h-5 fill-current text-purple-600" viewBox="0 0 24 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="text-gray-700 font-medium flex justify-center mt-6 pt-5 border-t border-gray-700">
                {/* <cite className="text-gray-200 not-italic"></cite>  */}
                <a className="text-[#d8aa6f] text-center hover:text-gray-200 transition duration-150 ease-in-out" href="#team">BNB Chain</a>
              </div>
            </div>
            ...
            <div className="flex flex-col h-full p-6 bg-gray-200" data-aos="fade-up" data-aos-delay="1000">
              <div>
                {/* <div className="relative inline-flex flex-col mb-4">
                  <Image className="rounded-full" src={TestimonialImage01} width={48} height={48} alt="Testimonial 01" />
                  <svg className="absolute top-0 right-0 -mr-3 w-6 h-5 fill-current text-purple-600" viewBox="0 0 24 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="text-gray-700 font-medium flex justify-center mt-6 pt-5 border-t border-gray-700">
                {/* <cite className="text-gray-200 not-italic"></cite>  */}
                <a className="text-[#d8aa6f] text-center hover:text-gray-200 transition duration-150 ease-in-out" href="#team">Chain Link</a>
              </div>
            </div>
